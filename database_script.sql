...
-- Dumping database structure for bookshopdb2
CREATE DATABASE IF NOT EXISTS `bookshopdb2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `bookshopdb2`;

-- Dumping structure for table bookshopdb2.accuracyuser
...
-- Dumping structure for table bookshopdb2.address
...
INSERT INTO `address` (`id`, `userId`, `houseNumber`, `province`, `district`, `ward`) VALUES
	...
	(44, 1, '435', 'Hà Nội', 'QUẬN HOÀN KIẾM', 'XÃ THIỆU KHÁNH'),
	(45, 1714833219717, '123', 'Hà Nội', 'QUẬN HOÀN KIẾM', 'XÃ THIỆU KHÁNH'),
	(46, 1714833219717, '231', 'Tiền Giang', 'HUYỆN CHÂU THÀNH', 'THỊ TRẤN TÂN HIỆP'),
	(47, 1714833219717, '321', 'Hải Dương', 'THÀNH PHỐ HẢI DƯƠNG', 'XÃ GIA XUYÊN'),
	(48, 1714833219717, '001', 'Nam Ðịnh', 'HUYỆN NAM TRỰC', 'XÃ NAM HÙNG'),
	(49, 1, '123', 'Hà Nội', 'QUẬN HOÀN KIẾM', 'XÃ THIỆU KHÁNH'),
	(50, 1, '11111', 'Hà Nội', 'QUẬN HOÀN KIẾM', 'XÃ THIỆU KHÁNH'),
	(51, 1, '1111', 'Hà Nội', 'QUẬN HOÀN KIẾM', 'XÃ THIỆU KHÁNH'),
	(52, 1, '1122', 'Hà Nội', 'QUẬN HOÀN KIẾM', 'XÃ THIỆU KHÁNH');

-- Dumping structure for table bookshopdb2.cart
...
-- Dumping data for table bookshopdb2.cart_item: ~14 rows (approximately)
INSERT INTO `cart_item` (`id`, `cartId`, `productId`, `quantity`, `createdAt`, `updatedAt`) VALUES
	...
	(35, 8, 22, 5, '2024-06-05 07:50:12', '2024-06-05 07:50:11'),
	(37, 8, 78, 7, '2024-06-05 07:45:52', '2024-06-05 07:45:52'),
	(38, 8, 99, 1, '2024-06-05 07:35:45', NULL),
	(40, 8, 46, 1, '2024-06-05 07:47:02', NULL),
	(41, 8, 93, 1, '2024-06-05 07:50:19', NULL);

-- Dumping structure for table bookshopdb2.category
...
-- Dumping data for table bookshopdb2.category: ~15 rows (approximately)
INSERT INTO `category` (`id`, `name`, `description`, `imageName`) VALUES
	(1, 'Sách giáo khoa', 'Cillum nulla non Lorem ut irure fugiat veniam deserunt do.', 'https://i.imgur.com/RrRmFKk.jpeg'),
	(2, 'Sách khoa học', 'Aliqua exercitation ea sint do.', 'https://i.imgur.com/KcHN3u1.png'),
	(3, 'Truyện tranh', 'Cillum laboris et nulla nostrud duis consectetur labore cupidatat minim proident.', 'https://i.imgur.com/VgY26Cx.png'),
	(4, 'Tiểu thuyết', 'Enim dolore cupidatat tempor sunt amet veniam aute officia est officia.', 'https://i.imgur.com/KcyJwZ2.png'),
	(5, 'Truyện ngắn', 'Dolor in pariatur aliqua dolore ea cillum ut consectetur tempor do eu incididunt est.', 'https://i.imgur.com/3zFyqaT.png'),
	(6, 'Truyện dài', 'Eiusmod adipisicing consectetur occaecat culpa in ullamco labore velit magna.', 'https://i.imgur.com/WzN1KQf.png'),
	(7, 'Sách giáo trình', 'In officia ex magna commodo ullamco in magna incididunt esse mollit enim consectetur laboris.', 'https://i.imgur.com/58NzNP0.png'),
	(8, 'Báo in', 'Laborum in elit ullamco pariatur laborum magna veniam nostrud eu anim irure deserunt ad sunt.', 'https://i.imgur.com/zVl5l0r.png'),
	(9, 'Tạp chí', 'Excepteur qui commodo sint sint irure sunt sunt in nostrud.', 'https://i.imgur.com/cCvKO2J.png'),
	(10, 'Tập san', 'Elit amet proident et cupidatat in eu quis velit tempor sunt labore aute et.', 'https://i.imgur.com/wYdmpnZ.png'),
	(11, 'Sách nấu ăn', 'Consequat anim officia aute eiusmod dolor.', 'https://i.imgur.com/AcvSfAT.png'),
	(12, 'Sách kỹ thuật', 'Veniam pariatur deserunt ea non voluptate sunt do culpa elit esse.', 'https://i.imgur.com/Q5ymnZW.png'),
	(13, 'Sách nông nghiệp', 'Minim deserunt aute ipsum duis ea eiusmod aute sint sint ut.', 'https://i.imgur.com/PDyiDGv.png'),
	(14, 'Sách thiếu nhi', 'Ex eu ad adipisicing magna tempor occaecat id cupidatat dolor dolor aliquip dolore.', 'https://i.imgur.com/De4z9p1.png'),
	(15, 'Sách kỹ năng sống', 'Ad exercitation anim in magna qui ipsum ipsum proident magna.', 'https://i.imgur.com/xQ6A6vt.png');

-- Dumping structure for table bookshopdb2.categorys_of_voucher
...
-- Dumping data for table bookshopdb2.categorys_of_voucher: ~7 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `google_user` (
  ...
  `googleId` bigint(20) NOT NULL,
  PRIMARY KEY (`googleId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table bookshopdb2.google_user: ~0 rows (approximately)

-- Dumping structure for table bookshopdb2.log
...
-- Dumping data for table bookshopdb2.log: ~391 rows (approximately)
...
-- Dumping structure for table bookshopdb2.orders
...
-- Dumping data for table bookshopdb2.orders: ~31 rows (approximately)
...
-- Dumping structure for table bookshopdb2.order_detail
...
-- Dumping data for table bookshopdb2.order_detail: ~3 rows (approximately)
...
-- Dumping structure for table bookshopdb2.order_item
...
-- Dumping data for table bookshopdb2.order_item: ~76 rows (approximately)
...
-- Dumping structure for table bookshopdb2.otp
...
-- Dumping data for table bookshopdb2.product_category: ~100 rows (approximately)
...
-- Dumping structure for table bookshopdb2.product_import
...
-- Dumping data for table bookshopdb2.product_import: ~100 rows (approximately)
...
-- Dumping structure for table bookshopdb2.product_review
...
-- Dumping data for table bookshopdb2.product_review: ~152 rows (approximately)
...
-- Dumping data for table bookshopdb2.voucher: ~4 rows (approximately)
INSERT INTO `voucher` (`id`, `voucher_code`, `voucher_name`, `description`, `quantity`, `percent_decrease`, `max_decrease`, `min_price`, `type`, `createAt`, `startAt`, `endAt`, `voucher_image`) VALUES
	...
	(10, 'OWHhiU', 'Freeship', '', 50, 50, 100000, 100000, 0, '2024-06-04 17:02:11', '2024-06-04 17:00:00', '2024-10-05 17:00:00', 'https://i.imgur.com/hDFplsi.png'),
...
-- Dumping structure for table bookshopdb2.wishlist_item
...
INSERT INTO `wishlist_item` (`id`, `userId`, `productId`, `createdAt`) VALUES
	...
	(41, 1, 99, '2024-06-12 10:33:38'),
	(45, 1, 55, '2024-06-13 15:13:00'),
	(46, 1, 56, '2024-06-13 15:15:45'),
	(47, 1, 57, '2024-06-13 15:15:51'),
	(49, 1, 76, '2024-06-16 14:37:08');
